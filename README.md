...
<img src="https://img.shields.io/badge/Project-Computer%20Organization-orange?style=for-the-badge">
...
Example errors generated by the assembler:

```text
Invalid register 'x33' at line 5
```

```text
Immediate out of range in line number 8
```
...
This project recreates one of the most fundamental tools in computer systems — an **Assembler**.

It gives practical understanding of:
- How processors understand instructions
- How assembly converts into machine code
- How branch addresses are calculated
- How low-level software communicates with hardware
...
Built as part of a **Computer Organization Project** focused on implementing a custom **RISC-V RV32I Assembler** using Python.
